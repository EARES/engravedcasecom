  ...
  <div class="main-container">
    ...
    <div class="page-content left-vertical-header">
      ...
      <div class="position-relative bg-white" style="z-index: 9999999999">
        <!-- Start About Area -->
        <div
          class="brook-about-area bg_color--1 ptb--120 ptb-md--80 ptb-sm--60"
        >
          <div class="container">
              ...
              <div class="col-xl-4 col-lg-6 col-md-12">
                <div class="about-inner authenthick-about pr--30">
                  ...
                  <p class="font-size-18 wow move-up">
                    ...
                    <br />
                    <i
                      >To provide customers with the ability to personalise
                      their products with intricate engravings and designs.</i
                    >
                  </p>
